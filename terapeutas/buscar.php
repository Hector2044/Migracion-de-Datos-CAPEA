...
<button class = "botonesTe" onclick="location.href='index.php'"> Volver </button>
...
<table class="tabladatos">
        ...
        <?php
          ...
          $sql = "SELECT id, Nombre, Grupo, Hora FROM terapeuta WHERE Nombre like '$buscar' '%' order by id desc";
